...
Realms.FEATURES_ADDED = {
  ...
  'Bloodied':'Section=combat,skill Note="+2 Initiative","+2 Spot"',
  ...
  'DelaySpell':'Section=magic Note="Delay effect of spell 1-5 rounds"',
  ...
  'Innate Spell':'Section=magic Note="Designated spells as spell-like ability 1/round uses +8 spell slot"',
  ...
  'Magical Training':'Section=magic Note="<i>Dancing Lights</i>, <i>Daze</i>, <i>Mage Hand</i> 1/day"',
  ...
  'Peresistent Spell':'Section=magic Note="24 hour duration on chosen spell"',
  'Resist Poison':'Section=save Note="+4 poison"',
  ...
  'Tree Topper':'Section=skill Note="+2 Climb"',
...
Realms.SPELLS_ADDED = {
  ...
  'Create Magic Tatoo':
    'School=Conjuration ' +
    'Description="Touched gains tatoo w/variable effects for 1 day"',
  'Darkbolt':
    'School=Evocation ' +
